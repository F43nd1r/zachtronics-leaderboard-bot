...
public enum TISCategory implements CategoryJava<TISCategory, TISScore, TISMetric<?>> {
    ...
    aCN(ACHIEV_LEGIT, List.of(ACHIEV_LEGIT, CYCLES, NODES, INSTRUCTIONS), 0b100),
    aCI(ACHIEV_LEGIT, List.of(ACHIEV_LEGIT, CYCLES, INSTRUCTIONS, NODES), 0b100),
    aCX(ACHIEV_LEGIT, List.of(ACHIEV_LEGIT, CYCLES, PROD_NI), 0b100),

    aNC(ACHIEV_LEGIT, List.of(ACHIEV_LEGIT, NODES, CYCLES, INSTRUCTIONS), 0b010),
    aNI(ACHIEV_LEGIT, List.of(ACHIEV_LEGIT, NODES, INSTRUCTIONS, CYCLES), 0b010),
    aNX(ACHIEV_LEGIT, List.of(ACHIEV_LEGIT, NODES, PROD_CI), 0b010),

    aIC(ACHIEV_LEGIT, List.of(ACHIEV_LEGIT, INSTRUCTIONS, CYCLES, NODES), 0b001),
    aIN(ACHIEV_LEGIT, List.of(ACHIEV_LEGIT, INSTRUCTIONS, NODES, CYCLES), 0b001),
    aIX(ACHIEV_LEGIT, List.of(ACHIEV_LEGIT, INSTRUCTIONS, PROD_CN), 0b001),

    acCN(ACHIEVEMENT, List.of(ACHIEVEMENT, CYCLES, NODES, INSTRUCTIONS), 0b100),
    acCI(ACHIEVEMENT, List.of(ACHIEVEMENT, CYCLES, INSTRUCTIONS, NODES), 0b100),
    acCX(ACHIEVEMENT, List.of(ACHIEVEMENT, CYCLES, PROD_NI), 0b100),

    acNC(ACHIEVEMENT, List.of(ACHIEVEMENT, NODES, CYCLES, INSTRUCTIONS), 0b010),
    acNI(ACHIEVEMENT, List.of(ACHIEVEMENT, NODES, INSTRUCTIONS, CYCLES), 0b010),
    acNX(ACHIEVEMENT, List.of(ACHIEVEMENT, NODES, PROD_CI), 0b010),

    acIC(ACHIEVEMENT, List.of(ACHIEVEMENT, INSTRUCTIONS, CYCLES, NODES), 0b001),
    acIN(ACHIEVEMENT, List.of(ACHIEVEMENT, INSTRUCTIONS, NODES, CYCLES), 0b001),
    acIX(ACHIEVEMENT, List.of(ACHIEVEMENT, INSTRUCTIONS, PROD_CN), 0b001),
