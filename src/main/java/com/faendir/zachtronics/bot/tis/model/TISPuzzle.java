...
public enum TISPuzzle implements Puzzle<TISCategory> {
    ...
    SEQUENCE_SORTER(TIS_100_SEGMENT_MAP, "63534", "SEQUENCE SORTER", STANDARD,
                    200132, 200206, 200287, 200308, 200578, 202012, 202927, 205591, 207089, 207480,
                    215493, 216246, 222497, 224109, 236763, 265724, 282624,
                    300280, 309856, 357831, 373826, 449198, 488297, 617519, 661244, 901742,
                    1313389, 1837283, 1822200, 1900806),
    ...
    DECIMAL_DECOMPOSER(TIS_NET_DIRECTORY, "NEXUS.08.633.9", "DECIMAL DECOMPOSER", STANDARD, 200006, 200030, 200053, 200307, 200677, 204958),
    ...
    SIGNAL_EXPONENTIATOR(TIS_NET_DIRECTORY, "NEXUS.21.601.6", "SIGNAL EXPONENTIATOR", STANDARD, 207405, 233221, 244781, 4189154),
    ...
    NUMERAL_AMALGAMATOR(TOURNAMENT_2018, "SPEC49083185", "NUMERAL AMALGAMATOR", STANDARD, 200050, 200483),
    ...
    TRI_SEQUENCE_IDENTIFIER(TOURNAMENT_2018, "SPEC26159035", "TRI-SEQUENCE IDENTIFIER", STANDARD, 222666),
    STRIATION_PLOTTER(TOURNAMENT_2018, "SPEC35049542", "STRIATION PLOTTER", STANDARD,
                      202696, 205338, 211921, 367958, 370809, 434589, 573621),
