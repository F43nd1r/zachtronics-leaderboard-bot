...
public enum TISPuzzle implements Puzzle<TISCategory> {
    ...
    SEQUENCE_SORTER(TIS_100_SEGMENT_MAP, "63534", "SEQUENCE SORTER", STANDARD,
                    200025, 200578, 202927, 207089, 207480, 215493, 222497, 224109, 265724, 282624,
    ...
    SIGNAL_AVERAGER(TIS_NET_DIRECTORY, "NEXUS.06.786.0", "SIGNAL AVERAGER", STANDARD, 202116 /* 100+100 */, 211527, 212654 /* 999+999 */),
    SUBMAXIMUM_SELECTOR(TIS_NET_DIRECTORY, "NEXUS.07.050.0", "SUBMAXIMUM SELECTOR", STANDARD),
    DECIMAL_DECOMPOSER(TIS_NET_DIRECTORY, "NEXUS.08.633.9", "DECIMAL DECOMPOSER", STANDARD, 200030),
    SEQUENCE_MODE_CALCULATOR(TIS_NET_DIRECTORY, "NEXUS.09.904.9", "SEQUENCE MODE CALCULATOR", STANDARD, 205321, 208015),
    ...
    WAVE_COLLAPSE_SUPERVISOR(TIS_NET_DIRECTORY, "NEXUS.24.511.7", "WAVE COLLAPSE SUPERVISOR", STANDARD, 200695, 202001);
