...
public enum TISPuzzle implements Puzzle<TISCategory> {
    ...
    SIGNAL_EDGE_DETECTOR(TIS_100_SEGMENT_MAP, "32050", "SIGNAL EDGE DETECTOR", STANDARD, 200009),
    ...
    SEQUENCE_SORTER(TIS_100_SEGMENT_MAP, "63534", "SEQUENCE SORTER", STANDARD,
                    200025, 200206, 200287, 200578, 202927, 207089, 207480, 215493, 216246, 222497, 224109, 265724, 282624,
    ...
    SUBMAXIMUM_SELECTOR(TIS_NET_DIRECTORY, "NEXUS.07.050.0", "SUBMAXIMUM SELECTOR", STANDARD, 200009, 200031, 200713),
    DECIMAL_DECOMPOSER(TIS_NET_DIRECTORY, "NEXUS.08.633.9", "DECIMAL DECOMPOSER", STANDARD, 200006, 200030, 200053),
    SEQUENCE_MODE_CALCULATOR(TIS_NET_DIRECTORY, "NEXUS.09.904.9", "SEQUENCE MODE CALCULATOR", STANDARD, 200038, 205321, 208015, 210952),
    SEQUENCE_NORMALIZER(TIS_NET_DIRECTORY, "NEXUS.10.656.5", "SEQUENCE NORMALIZER", STANDARD,
                        200022, 200122, 200199, 200222, 203080, 205237, 209353, 217852, 224884, 283860, 329689),
    ...
    T31_NODE_EMULATOR(TIS_NET_DIRECTORY, "NEXUS.23.727.9", "T31 NODE EMULATOR", STANDARD, 218959),
