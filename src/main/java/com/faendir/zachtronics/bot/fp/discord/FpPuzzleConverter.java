...
public class FpPuzzleConverter implements OptionConverter<String, FpPuzzle> {
    @NotNull
    @Override
    public SingleParseResult<FpPuzzle> fromValue(@NotNull ChatInputInteractionEvent context, @NotNull String value) {
        return FpPuzzle.parsePuzzle(value);
    }
