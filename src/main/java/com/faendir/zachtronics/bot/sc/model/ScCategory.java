...
public enum ScCategory implements Category {
    C("C", List.of(CYCLES, REACTORS, SYMBOLS), EnumSet.of(RESEARCH, PRODUCTION, PRODUCTION_TRIVIAL), F100),
    ...
    S("S", List.of(SYMBOLS, REACTORS, CYCLES), EnumSet.of(RESEARCH, PRODUCTION, PRODUCTION_TRIVIAL), F001),
    ...
    RC("RC", List.of(REACTORS, CYCLES, SYMBOLS), Collections.singleton(PRODUCTION), F110),
    ...
    RS("RS", List.of(REACTORS, SYMBOLS, CYCLES), Collections.singleton(PRODUCTION), F011),
