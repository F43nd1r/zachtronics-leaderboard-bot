...
public enum ScCategory implements Category {
    C("C", List.of(CYCLES, REACTORS, SYMBOLS, ANY_FLAG), EnumSet.of(RESEARCH, PRODUCTION, PRODUCTION_TRIVIAL), F100),
    CNB("CNB", List.of(CYCLES, REACTORS, SYMBOLS, NO_BUGS), EnumSet.of(RESEARCH, PRODUCTION, PRODUCTION_TRIVIAL), F100),
    CNP("CNP", List.of(CYCLES, REACTORS, SYMBOLS, NO_PRECOG), EnumSet.of(RESEARCH, PRODUCTION, PRODUCTION_TRIVIAL), F100),

    S("S", List.of(SYMBOLS, REACTORS, CYCLES, ANY_FLAG), EnumSet.of(RESEARCH, PRODUCTION, PRODUCTION_TRIVIAL), F001),
    SNB("SNB", List.of(SYMBOLS, REACTORS, CYCLES, NO_BUGS), EnumSet.of(RESEARCH, PRODUCTION, PRODUCTION_TRIVIAL), F001),
    SNP("SNP", List.of(SYMBOLS, REACTORS, CYCLES, NO_PRECOG), EnumSet.of(RESEARCH, PRODUCTION, PRODUCTION_TRIVIAL), F001),

    RC("RC", List.of(REACTORS, CYCLES, SYMBOLS, ANY_FLAG), Collections.singleton(PRODUCTION), F110),
    RCNB("RCNB", List.of(REACTORS, CYCLES, SYMBOLS, NO_BUGS), Collections.singleton(PRODUCTION), F110),
    RCNP("RCNP", List.of(REACTORS, CYCLES, SYMBOLS, NO_PRECOG), Collections.singleton(PRODUCTION), F110),

    RS("RS", List.of(REACTORS, SYMBOLS, CYCLES, ANY_FLAG), Collections.singleton(PRODUCTION), F011),
    RSNB("RSNB", List.of(REACTORS, SYMBOLS, CYCLES, NO_BUGS), Collections.singleton(PRODUCTION), F011),
    RSNP("RSNP", List.of(REACTORS, SYMBOLS, CYCLES, NO_PRECOG), Collections.singleton(PRODUCTION), F011);
