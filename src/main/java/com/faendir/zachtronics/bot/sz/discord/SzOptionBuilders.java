...
public class SzOptionBuilders {
    public static @NonNull CommandOptionBuilder<String, SzPuzzle> puzzleOptionBuilder() {
    ...
    public static @NonNull CommandOptionBuilder<String, SzCategory> categoryOptionBuilder() {
