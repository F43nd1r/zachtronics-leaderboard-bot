...
public class ExaRecordDTO implements RecordDTO<ExaScoreDTO> {
    ...
    public static ExaRecordDTO fromCategoryRecord(CategoryRecord<ExaRecord, ExaCategory> categoryRecord) {
    ...
    public static ExaRecordDTO fromRecord(ExaRecord record) {
