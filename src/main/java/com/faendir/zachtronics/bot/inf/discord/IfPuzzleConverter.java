...
public class IfPuzzleConverter implements OptionConverter<String, IfPuzzle> {
    @NotNull
    @Override
    public SingleParseResult<IfPuzzle> fromValue(@NotNull ChatInputInteractionEvent context, @NotNull String value) {
        return IfPuzzle.parsePuzzle(value);
    }
}
