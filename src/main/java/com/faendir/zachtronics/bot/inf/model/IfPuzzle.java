...
public enum IfPuzzle implements Puzzle<IfCategory> {
    ...
    LEVEL_8_3("8-6", IfGroup.ZONE_8, IfType.STANDARD, "Docking Clamp"),
    ...
    LEVEL_8_6("8-7", IfGroup.ZONE_8, IfType.STANDARD, "Mag-Tube Corridor"),
    LEVEL_8_7("8-3", IfGroup.ZONE_8, IfType.STANDARD, "Solar Cell Array"),
    LEVEL_9_1("9-1", IfGroup.ZONE_9, IfType.STANDARD, "Landing Alignment Guide"),
    LEVEL_9_2("9-6", IfGroup.ZONE_9, IfType.STANDARD, "Control Console"),
    LEVEL_9_3("9-4", IfGroup.ZONE_9, IfType.STANDARD, "Laser Calibration Target"),
    LEVEL_9_4("9-3", IfGroup.ZONE_9, IfType.STANDARD, "Life Support System"),
    LEVEL_9_5("9-2", IfGroup.ZONE_9, IfType.STANDARD, "Space Buoy"),
    LEVEL_9_6("9-7", IfGroup.ZONE_9, IfType.STANDARD, "Resistance Shuttles"),
    LEVEL_10_1("10-2", IfGroup.ZONE_10, IfType.STANDARD, "Navigation Computer"),
    LEVEL_10_2("10-3", IfGroup.ZONE_10, IfType.STANDARD, "Fusion Reactor"),
    LEVEL_10_3("10-1", IfGroup.ZONE_10, IfType.STANDARD, "Crew Quarters"),
