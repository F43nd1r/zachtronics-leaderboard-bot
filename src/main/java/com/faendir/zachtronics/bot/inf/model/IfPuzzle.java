...
public enum IfPuzzle implements Puzzle<IfCategory> {
    ...
    LEVEL_2_2("2-2", IfGroup.ZONE_2, IfType.STANDARD, "Munitions Refill Type 6"),
    ...
    LEVEL_3_1("3-1", IfGroup.ZONE_3, IfType.STANDARD, "Optical Sensor Array Type 2"),
    ...
    LEVEL_3_4("3-4", IfGroup.ZONE_3, IfType.STANDARD, "Small Excavator"),
    LEVEL_3_5("3-5", IfGroup.ZONE_3, IfType.STANDARD, "Cargo Uplifter"),
    ...
    LEVEL_5_4("5-4", IfGroup.ZONE_5, IfType.STANDARD, "Terrestrial Surveyor"),
    ...
    @NotNull
    public static SingleParseResult<IfPuzzle> parsePuzzle(@NotNull String name) {
        return UtilsKt.getSingleMatchingPuzzle(IfPuzzle.values(), name);
    }
}
