...
function get_description()
	return { "OUTPUT IN.MU ROUNDED TO NEAREST MULTIPLE OF IN.NU TO OUT.M", "OUTPUT IN.MU ROUNDED TO NEAREST MULTIPLE OF (11-IN.NU) TO OUT.N", "IN CASE OF A TIE, ROUND DOWN" }
end
