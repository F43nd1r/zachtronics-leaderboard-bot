...
enum class DiscordUser(val id: Long, val getSpecialEmoji: (Guild?) -> Emoji? = { null }) {
    F43ND1R(288766560938622976, { Emoji.unicode("\uD83C\uDDEB") }),
    IEEE12345(295868901042946048, { Emoji.unicode("\uD83D\uDC18") }), // aka 12345IEEE
    TT(516462621382410260),
    ZIG(185983061190508544),
    OMGITSABIST(223019983557361664, { guild -> guild?.getEmojiById(Snowflake.of(1030311764182704138L))?.block() }),
    TULARE(219319015649181698, { Emoji.unicode("\uD83C\uDF52") }),
    REGULAR_HUMANOID(297954865223696384, { Emoji.unicode("\uD83D\uDC0C") }),
    BIGGIE(255092784128720896, { Emoji.unicode("\uD83C\uDF54") }),
    USERNAME_VOID(707408175976022086, { Emoji.unicode("\uD83D\uDD73") }),
    RP0(213469074598920193, { Emoji.unicode("\uD83D\uDC3C") }),
    BROTHER_MOJO(182628037601394688, { Emoji.unicode("\uD83D\uDD76\uFE0F") }),
    SPIRITUAL_SHAMPOO(930111778652835850, { Emoji.unicode("\uD83E\uDDF4") }),
    GRIMMY(107902495199604736, { Emoji.unicode("\uD83D\uDC9C") }),
