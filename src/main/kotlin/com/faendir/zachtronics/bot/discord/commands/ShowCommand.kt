...
class ShowCommand : Command {
    ...
    private fun <C : Category<S, P>, P : Puzzle, R : Record<S>, S : Score> Game<C, S, P, R>.parseCommand(command: MatchResult): Result<String> {
    ...
    private fun <C : Category<S, P>, S : Score, P : Puzzle, R : Record<S>> Game<C, S, P, R>.findRecord(puzzle: P, category: C): Result<String> {
    ...
    private fun <C : Category<*, P>, P : Puzzle> getSingleCategory(categories: List<C>, puzzle: P): Result<Pair<C, P>> {
    ...
    private fun <C : Category<*, *>> Game<C, *, *, *>.parseCategoryCandidates(name: String): Result<List<C>> {
