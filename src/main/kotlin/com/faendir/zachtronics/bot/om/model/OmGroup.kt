...
enum class OmGroup(val collection: OmCollection, override val displayName: String) : Group {
    ...
    JOURNAL_CVIII_VIII(JOURNAL_CVIII, "CVIII Issue VIII"),
    JOURNAL_CVIII_IX(JOURNAL_CVIII, "CVIII Issue IX"),
    JOURNAL_CVIII_X(JOURNAL_CVIII, "CVIII Issue X"),
    JOURNAL_CVIII_XI(JOURNAL_CVIII, "CVIII Issue XI"),
    JOURNAL_CVIII_XII(JOURNAL_CVIII, "CVIII Issue XII"),
