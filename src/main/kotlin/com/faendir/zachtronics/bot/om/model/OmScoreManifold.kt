...
enum class OmScoreManifold(
    ...
    VICTORY_HEIGHT("@hV", setOf(NORMAL, POLYMER_HEIGHT), listOf(OVERLAP, COST, CYCLES, HEIGHT, LOOPING, INSTRUCTIONS, TRACKLESS)),
    VICTORY_WIDTH("@wV", setOf(NORMAL, POLYMER_WIDTH), listOf(OVERLAP, COST, CYCLES, WIDTH, LOOPING, INSTRUCTIONS, TRACKLESS)),
    ...
    INFINITY_HEIGHT("@h∞", setOf(NORMAL, POLYMER_HEIGHT), listOf(OVERLAP, COST, RATE, HEIGHT_INF, INSTRUCTIONS, TRACKLESS)),
    INFINITY_WIDTH("@w∞", setOf(NORMAL, POLYMER_WIDTH), listOf(OVERLAP, COST, RATE, WIDTH_INF, INSTRUCTIONS, TRACKLESS)),
