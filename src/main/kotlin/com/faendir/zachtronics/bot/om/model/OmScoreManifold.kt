...
private val FREESPACE_TYPES = setOf(NORMAL, HEIGHT_POLYMER, WIDTH_POLYMER, POLYMER)
...
enum class OmScoreManifold(
    ...
    VICTORY_HEIGHT("@hV", setOf(NORMAL, HEIGHT_POLYMER), listOf(OVERLAP, COST, CYCLES, HEIGHT, LOOPING, INSTRUCTIONS, TRACKLESS)),
    VICTORY_WIDTH("@wV", setOf(NORMAL, WIDTH_POLYMER), listOf(OVERLAP, COST, CYCLES, WIDTH, LOOPING, INSTRUCTIONS, TRACKLESS)),
    ...
    INFINITY_HEIGHT("@h∞", setOf(NORMAL, HEIGHT_POLYMER), listOf(OVERLAP, COST, RATE, HEIGHT_INF, INSTRUCTIONS, TRACKLESS)),
    INFINITY_WIDTH("@w∞", setOf(NORMAL, WIDTH_POLYMER), listOf(OVERLAP, COST, RATE, WIDTH_INF, INSTRUCTIONS, TRACKLESS)),
