...
enum class OmCategory(
    ...
    TC(NORMAL_TYPES, TRACKLESS, AREA, COST, displayName = "TC"),
    ...
    HR(NORMAL_TYPES, OmMetric.HEIGHT, RATE, COST, displayName = "HC"),
    WR(setOf(NORMAL), OmMetric.WIDTH, RATE, COST, displayName = "WC"),
