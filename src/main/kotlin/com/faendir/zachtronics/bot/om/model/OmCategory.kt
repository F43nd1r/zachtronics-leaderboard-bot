...
enum class OmCategory(
    ...
    OSUM(VICTORY_AREA, ANYTHING_GOES, SUM3A, displayName = "OSum"),
    OSUM_P(VICTORY_PROD, ANYTHING_GOES, SUM3I, displayName = "OSum"),

    OSUM4(VICTORY_AREA, ANYTHING_GOES, OmMetric.SUM4, displayName = "OSum4"),
