...
enum class OmPuzzle(
    ...
    MINERAL_OIL(JOURNAL_CVIII_XI, NORMAL, "Mineral Oil", "P307"),
    GRINDSTONE(JOURNAL_CVIII_XI, NORMAL, "Grindstone", "P305"),
    MILD_STEEL(JOURNAL_CVIII_XI, NORMAL, "Mild Steel", "P308"),
    ROCKWOOL_FIBER(JOURNAL_CVIII_XI, POLYMER_WIDTH, "Rockwool Fiber", "P306"),
    RESIN_GLUE(JOURNAL_CVIII_XI, NORMAL, "Resin Glue", "P309"),

    LAPIS_SOLARIS(JOURNAL_CVIII_XII, NORMAL, "Lapis Solaris", "P313"),
    BRAZING_SILVER(JOURNAL_CVIII_XII, POLYMER_SKEW, "Brazing Silver", "P310"),
    UNIVERSAL_OINTMENT(JOURNAL_CVIII_XII, NORMAL, "Universal Ointment", "P314"),
    BRILLIANT_PIGMENT(JOURNAL_CVIII_XII, PRODUCTION, "Brilliant Pigment", "P311"),
    GUIPURE_LACE(JOURNAL_CVIII_XII, POLYMER_HEIGHT, "Guipure Lace", "P312"),
