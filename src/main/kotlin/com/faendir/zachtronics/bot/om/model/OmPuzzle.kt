...
enum class OmPuzzle(
    ...
    BANDAGE_THREAD(JOURNAL_X, POLYMER, "Bandage Thread", "P248"),
    ...
    SURVEYING_MAGNET(JOURNAL_CVIII_II, POLYMER, "Surveying Magnet", "P262"),
    ...
    MIRACULOUS_DENTIFRICE(JOURNAL_CVIII_III, POLYMER, "Miraculous Dentifrice", "P266"),
    STEEL_WOOL(JOURNAL_CVIII_III, POLYMER, "Steel Wool", "P268"),
    ...
    LAPIDARY_SAW(JOURNAL_CVIII_V, POLYMER, "Lapidary Saw", "P278"),
    ...
    BALING_FIBER(JOURNAL_CVIII_VII, POLYMER, "Baling Fiber", "P286"),
