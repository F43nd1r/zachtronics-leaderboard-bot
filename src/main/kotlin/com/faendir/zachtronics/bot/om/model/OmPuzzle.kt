...
enum class OmPuzzle(
    ...
    ARMOR_FILAMENT(CHAPTER_2, HEIGHT_POLYMER, "Armor Filament", "P020"),
    ...
    SOLDER_WIRE(DRM_CHAPTER_2, HEIGHT_POLYMER, "Solder Wire", "P209"),
    ...
    VAN_BERLO_S_CHAIN(JOURNAL_I, HEIGHT_POLYMER, "Van Berlo's Chain", "P055"),
    ...
    SAILCLOTH_THREAD(JOURNAL_II, HEIGHT_POLYMER, "Sailcloth Thread", "P061"),
    BUOYANT_CABLE(JOURNAL_II, HEIGHT_POLYMER, "Buoyant Cable", "P062"),
    SPYGLASS_CRYSTAL(JOURNAL_II, NORMAL, "Spyglass Crystal", "P063"),

    RAVARI_S_WHEEL(JOURNAL_III, NORMAL, "Ravari's Wheel", "P064"),
    LUBRICATING_FILAMENT(JOURNAL_III, HEIGHT_POLYMER, "Lubricating Filament", "P065"),
    RESONANT_CRYSTAL(JOURNAL_III, NORMAL, "Resonant Crystal", "P066"),
    REFINED_BRONZE(JOURNAL_III, HEIGHT_POLYMER, "Refined Bronze", "P067"),
    ...
    SUTURE_THREAD(JOURNAL_V, HEIGHT_POLYMER, "Suture Thread", "P085"),
    ...
    ASSASSIN_S_FILAMENT(JOURNAL_VII, HEIGHT_POLYMER, "Assassin's Filament", "P097"),
    ...
    CELESTIAL_THREAD(JOURNAL_VIII, HEIGHT_POLYMER, "Celestial Thread", "P101"),
    ...
    ELECTRUM_SEPARATION(JOURNAL_VIII, HEIGHT_POLYMER, "Electrum Separation", "P103"),
    ...
    BANDAGE_THREAD(JOURNAL_X, HEIGHT_POLYMER, "Bandage Thread", "P248"),
    ...
    MOORING_CABLE(JOURNAL_CVIII_I, HEIGHT_POLYMER, "Mooring Cable", "P255"),
    ...
    SURVEYING_MAGNET(JOURNAL_CVIII_II, HEIGHT_POLYMER, "Surveying Magnet", "P262"),
    ...
    MIRACULOUS_DENTIFRICE(JOURNAL_CVIII_III, HEIGHT_POLYMER, "Miraculous Dentifrice", "P266"),
    STEEL_WOOL(JOURNAL_CVIII_III, HEIGHT_POLYMER, "Steel Wool", "P268"),
    ...
    LAPIDARY_SAW(JOURNAL_CVIII_V, HEIGHT_POLYMER, "Lapidary Saw", "P278"),
    ...
    BALING_FIBER(JOURNAL_CVIII_VII, HEIGHT_POLYMER, "Baling Fiber", "P286"),
    ...
    XYLEM_SUBSTITUTE(JOURNAL_CVIII_IX, WOLYMER, "Xylem Substitute", "P297"),
    BLAST_CORDAGE(JOURNAL_CVIII_IX, WOLYMER, "Blast Cordage", "P299"),
    DURABLE_STITCHING(JOURNAL_CVIII_IX, HEIGHT_POLYMER, "Durable Stitching", "P296"),
    SHIMMERING_CHAIN(JOURNAL_CVIII_IX, WOLYMER, "Shimmering Chain", "P295"),
    MIRRORING_AMALGAM(JOURNAL_CVIII_IX, WOLYMER, "Mirroring Amalgam", "P298"),

    UNWINDING(TOURNAMENT_2019, NORMAL, "Unwinding", "w1611998067", "week1"),
    WIRE_FORMING_AND_UNFORMING(TOURNAMENT_2019, HEIGHT_POLYMER, "Wire Forming and Unforming", "w1698784331", "week2"),
    ...
    SWAMP_FIBER(TOURNAMENT_2020, HEIGHT_POLYMER, "Swamp Fiber", "w2501727889", "OM2020_W3_SwampFiber"),
    ...
    CALM_BEFORE_THE_STORM(TOURNAMENT_2021, HEIGHT_POLYMER, "Calm before the Storm", "w2450512434", "OM2021_W5"),
    ...
    RUST_REMOVAL(TOURNAMENT_2022, HEIGHT_POLYMER, "Rust Removal", "w2788066771", "OM2022_RustRemoval"),
    ...
    BIOSTEEL_FILAMENT(TOURNAMENT_2023, HEIGHT_POLYMER, "Biosteel Filament", "w2946684529", "OM2023_W4_BiosteelFilament"),
    ...
    THERMAL_FUSE(TOURNAMENT_2024, HEIGHT_POLYMER, "Thermal Fuse", "w3210188410", "OM2024_W6_Thermal_Fuse"),
    ...
    IMMORTAL_FILAMENT(TOURNAMENT_2026, HEIGHT_POLYMER, "Immortal Filament", "w3728200326", "OM2026_W7_Immortal_Filament"),
    ...
    IGNITION_CORD(WEEKLIES_1, HEIGHT_POLYMER, "Ignition Cord", "w2839120106", "OM2022Weeklies_IgnitionCord"),
