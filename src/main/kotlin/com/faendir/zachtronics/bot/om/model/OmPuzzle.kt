...
enum class OmPuzzle(
    ...
    SAVERIO_S_TEST(CHAPTER_DRM_1, NORMAL, "Saverio's Test", "P201")
    ELEMENTAL_COPPER(CHAPTER_DRM_1, NORMAL, "Elemental Copper", "P202")
    SILVER_DUST(CHAPTER_DRM_1, NORMAL, "Silver Dust", "P203")
    SAVERIO_S_TRANSFORMER(CHAPTER_DRM_1, PRODUCTION, "Saverio's Transformer", "P204")
    MIXED_USE_LUBRICANT(CHAPTER_DRM_1, NORMAL, "Mixed-Use Lubricant", "P205")
    METALLIC_TINCTURE(CHAPTER_DRM_1, NORMAL, "Metallic Tincture", "P206")
    GALENA_SEPARATION(CHAPTER_DRM_1, NORMAL, "Galena Separation", "P207")

    METAL_DIVISION(CHAPTER_DRM_2, NORMAL, "Metal Division", "P208")
    SOLDER_WIRE(CHAPTER_DRM_2, POLYMER, "Solder Wire", "P209")
    REACTIVE_LEAD(CHAPTER_DRM_2, NORMAL, "Reactive Lead", "P210")
    FIREWORKS_POWDER(CHAPTER_DRM_2, NORMAL, "Fireworks Powder", "P211")
    ARMOR_POLISH(CHAPTER_DRM_2, NORMAL, "Armor Polish", "P213")

    INVARIANT_METAL(CHAPTER_DRM_3, NORMAL, "Invariant Metal", "P215")
