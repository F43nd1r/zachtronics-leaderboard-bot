...
enum class OmPuzzle(
    ...
    LODESTONE(JOURNAL_CVIII_ISSUE_I, NORMAL, "Lodestone", "P256"),
    MOORING_CABLE(JOURNAL_CVIII_ISSUE_I, POLYMER, "Mooring Cable", "P255"),
    ESSENCE_OF_CITRUS(JOURNAL_CVIII_ISSUE_I, NORMAL, "Essence of Citrus", "P257"),
    LIGHTHOUSE_MIRROR(JOURNAL_CVIII_ISSUE_I, NORMAL, "Lighthouse Mirror", "P258"),
    GRENADE_PELLET(JOURNAL_CVIII_ISSUE_I, NORMAL, "Grenade Pellet", "P259"),
