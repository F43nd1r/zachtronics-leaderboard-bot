...
export default function CategoryView() {
    ...
    useEffect(() => {
        fetchFromApi<Record[]>(`/category/${categoryId}/records`, setState).then((data) => setRecords(data))
    }, [categoryId])
    ...
    switch (state) {
        ...
        case ComponentState.READY:
            content = <RecordGrid records={records} getTitle={(record) => record.puzzle.displayName} />
            break
    }
